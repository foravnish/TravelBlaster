...
class SeeAllListingAdapter() : RecyclerView.Adapter<SeeAllListingAdapter.ViewHolder>() {
...
//    }
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        val layoutInflator: LayoutInflater = LayoutInflater.from(p0!!.context)
         binding = DataBindingUtil.inflate(layoutInflator, R.layout.row_see_all, p0, false)
