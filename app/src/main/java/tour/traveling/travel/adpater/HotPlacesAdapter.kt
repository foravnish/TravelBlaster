...
class HotPlacesAdapter() : RecyclerView.Adapter<HotPlacesAdapter.ViewHolder>() {

    lateinit var callback: ProductCallback
    var list: MutableList<ResultItemBanner>? = null

    lateinit var binding: ViewDataBinding
    fun setData(list :MutableList<ResultItemBanner>) {
        this.list = list
