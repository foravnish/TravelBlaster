 ...
 */
class GallaryFragmentHistory : Fragment(), GallaryAdapter.GalleryCallback {
    ...
    companion object {
        ...
        fun newInstance(args: Bundle?): GallaryFragmentHistory {
            val fragment =
                GallaryFragmentHistory()
    ...
    override fun onCreateView(
        ...
        setGalleryImages(str!!.package_id!!.get(0).package_images)
    ...
    override fun onGalleryCallback(pos: Int,imgName: String) {
        ...
        intent.putExtra("list", str!!.package_id!!.get(0).package_images as Serializable?)
        intent.putExtra("image", str!!.package_id!!.get(0).package_images!!.get(pos))
