 ...
 */
class GallaryCategoryFragment : Fragment(), GallaryAdapter.GalleryCallback {
    ...
    companion object {
        val TAG = "GallaryCategoryFragment"
        fun newInstance(args: Bundle?): GallaryCategoryFragment {
            val fragment = GallaryCategoryFragment()
