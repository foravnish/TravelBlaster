 ...
 */
class ItineraryCategoryFragment() : Fragment() {
    ...
    companion object {
        val TAG = "ItineraryCategoryFragment"
        fun newInstance(args: Bundle?): ItineraryCategoryFragment {
            val fragment = ItineraryCategoryFragment()
